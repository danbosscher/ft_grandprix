...
class Driver:
    ...
    def maybe_recover(self, completion, heading_error, front_clear, actual_speed):
        ...
        if should_recover:
            ...
            return self.maybe_recover(completion, heading_error, front_clear, actual_speed)
        return None
    ...
    def process_lidar(self, ranges, state):
        ...
        recovery = self.maybe_recover(completion, heading_error, front_clear, actual_speed)
